// This example using cmdMessenger to light/off pin 13 led
// 
...
{
  digitalWrite(13, LOW);
  cmdMessenger.sendCmd(kACK,"led off");
}

void led_on()
{
  digitalWrite(13, HIGH);
  cmdMessenger.sendCmd(kACK, "led on");
}
...
// Timeout handling
long timeoutInterval = 1000; // 1 seconds
